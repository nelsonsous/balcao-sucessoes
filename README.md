...
| **Qualidade** | 0 violações axe-core (WCAG 2.2 AA) em 27 ecrãs, divisão de código por rota e separador, fontes só em latino, 303 testes (unitários, componentes com Testing Library e propriedades com fast-check, escala, cobertura com limiar, higiene do código-fonte) e 23 passos E2E com Chrome (telemóvel a 360 e 390 px e escritório grande) executados antes de cada publicação, com orçamento de tamanho do pacote. |
