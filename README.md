...
| **Qualidade** | 0 violações axe-core (WCAG 2.2 AA) em 26 ecrãs, divisão de código por rota e separador, fontes só em latino, 276 testes (unitários, componentes com Testing Library e propriedades com fast-check, cobertura com limiar, higiene do código-fonte) e 20 passos E2E com Chrome executados antes de cada publicação. |
