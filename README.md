...
| **Qualidade** | 0 violações axe-core (WCAG 2.2 AA) em 27 ecrãs, divisão de código por rota e separador, fontes só em latino, 292 testes (unitários, componentes com Testing Library e propriedades com fast-check, cobertura com limiar, higiene do código-fonte) e 22 passos E2E com Chrome (com auditoria do telemóvel a 360 e 390 px) executados antes de cada publicação. |
